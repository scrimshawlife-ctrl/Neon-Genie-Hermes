...
[![Version](https://img.shields.io/badge/version-3.15.0-7c3aed?style=for-the-badge)](./manifest.json)
...
Or copy **this repository root** into your Hermes skills directory (the root *is* the skill).
...
- Pre-3.2 installs used a nested `neon-genie/` folder; that layout is gone.
...
<div align="center">
<sub>Neon Genie v3.15.0 · OPEN → ALIGN → ASCEND → CLEAR → SEAL · advisory only</sub>
</div>
