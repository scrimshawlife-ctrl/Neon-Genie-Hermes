...
[![Version](https://img.shields.io/badge/version-3.18.0-7c3aed?style=for-the-badge)](./manifest.json)
...
<div align="center">
<sub>Neon Genie v3.18.0 · OPEN → ALIGN → ASCEND → CLEAR → SEAL · advisory only</sub>
</div>
