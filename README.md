...
[![Version](https://img.shields.io/badge/version-3.14.0-7c3aed?style=for-the-badge)](./manifest.json)
...
<sub>Neon Genie v3.14.0 · OPEN → ALIGN → ASCEND → CLEAR → SEAL · advisory only</sub>
